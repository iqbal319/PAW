<?php
	...
	if(isset($_POST['bsimpan']))
	{
		...
		{
			//Data akan di edit
			$edit = mysqli_query($koneksi, "UPDATE tb_004 set
											 	nim = '$_POST[tnim]',
											 	nama = '$_POST[tnama]',
		...
		else
		{
			...
			$simpan = mysqli_query($koneksi, "INSERT INTO tb_004 (nim, nama, alamat, prodi)
										  VALUES ('$_POST[tnim]', 
										  		 '$_POST[tnama]', 
										  		 '$_POST[talamat]', 
										  		 '$_POST[tprodi]')
	...
	if(isset($_GET['hal']))
	{
		...
		if($_GET['hal'] == "edit")
		{
			...
			$tampil = mysqli_query($koneksi, "SELECT * FROM tb_004 WHERE id_mhs = '$_GET[id]' ");
		...
		else if ($_GET['hal'] == "hapus")
		{
			...
			$hapus = mysqli_query($koneksi, "DELETE FROM tb_004 WHERE id_mhs = '$_GET[id]' ");
			if($hapus){
				echo "<script>
	...
	<div class="card mt-3">
	  ...
	  <div class="card-body">
	    ...
	    <table class="table table-bordered table-striped">
	    	...
	    	<?php
	    		$no = 1;
	    		$tampil = mysqli_query($koneksi, "SELECT * from tb_004 order by id_mhs desc");
